...
CLI::
    ...
    python -m delivery_workflow.lib.verify --agent research --slug my-feature --space /path/to/space
...
from delivery_workflow.lib.contract import (
    CC_VERSION,
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        prog="delivery_workflow.lib.verify",
        description=(
