...
depends_on:
- 2026-06-02-0753-review-frontend-tool-detail-panel
id: 2026-06-02-0753-doc-frontend-tool-detail-panel
manual_order: 0
...
state: backlog
title: doc – frontend-tool-detail-panel
type: task
...
CC-v1 doc phase for sub-goal: frontend ToolDetailPanel slide-over drawer component.
...
Artifact path: `.cronos/pipeline/ai-tools-detail-screens/doc-report-frontend-tool-detail-panel.md`
