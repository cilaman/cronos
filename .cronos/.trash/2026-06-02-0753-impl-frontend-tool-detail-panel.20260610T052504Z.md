...
depends_on:
- 2026-06-02-0753-architect-frontend-tool-detail-panel
id: 2026-06-02-0753-impl-frontend-tool-detail-panel
manual_order: 0
...
state: backlog
title: impl – frontend-tool-detail-panel
type: task
...
CC-v1 impl phase for sub-goal: frontend ToolDetailPanel slide-over drawer component.
...
Artifact path: `.cronos/pipeline/ai-tools-detail-screens/impl-report-frontend-tool-detail-panel.md`
