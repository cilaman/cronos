...
depends_on:
- 2026-06-02-0753-scout-ai-tools-detail-screens
id: 2026-06-02-0753-analyst-frontend-tool-detail-panel
manual_order: 0
...
state: backlog
title: analyst – frontend-tool-detail-panel
type: task
...
CC-v1 analyst phase for sub-goal: frontend ToolDetailPanel slide-over drawer component.
...
Follow the CC-v1 analyst agent contract (`.claude/agents/pipeline-analyst.md`).
Artifact path: `.cronos/pipeline/ai-tools-detail-screens/analyst-report-frontend-tool-detail-panel.md`
