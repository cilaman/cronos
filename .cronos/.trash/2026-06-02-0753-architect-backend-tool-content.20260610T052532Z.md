...
depends_on:
- 2026-06-02-0753-analyst-backend-tool-content
id: 2026-06-02-0753-architect-backend-tool-content
manual_order: 0
...
state: backlog
title: architect – backend-tool-content
type: task
...
CC-v1 architect phase for sub-goal: backend tool-content endpoint (GET /api/spaces/{space_id}/tool-content).
...
Artifact path: `.cronos/pipeline/ai-tools-detail-screens/architect-report-backend-tool-content.md`
