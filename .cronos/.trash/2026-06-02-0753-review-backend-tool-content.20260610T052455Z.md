...
depends_on:
- 2026-06-02-0753-test-backend-tool-content
id: 2026-06-02-0753-review-backend-tool-content
manual_order: 0
...
state: backlog
title: review – backend-tool-content
type: task
...
CC-v1 review phase for sub-goal: backend tool-content endpoint (GET /api/spaces/{space_id}/tool-content).
...
Artifact path: `.cronos/pipeline/ai-tools-detail-screens/review-report-backend-tool-content.md`
