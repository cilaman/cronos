...
depends_on:
- 2026-06-03-1026-pipeline-reviewer-arc-7-s1-mailbox-broke
id: 2026-06-03-1026-pipeline-doc-sync-arc-7-s1-mailbox-broke
manual_order: 0
...
state: backlog
title: 'pipeline-doc-sync: Arc 7/S1 — Mailbox broker + persistence + API'
type: task
...
# Phase 7 — doc: Arc 7/S1 — Mailbox broker + persistence + API

Goal slug: `arc7-mailbox-broker` · Pipeline dir: `.cronos/pipeline/arc7-mailbox-broker/` · Sub-agent: `pipeline-doc-sync`.
...
space  = $SPACE_DIR
review_report_path = .cronos/pipeline/arc7-mailbox-broker/review-report-arc7-mailbox-broker--attempt<final_k>.md
