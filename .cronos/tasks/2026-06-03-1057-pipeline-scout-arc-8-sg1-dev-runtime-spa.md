...
depends_on: []
id: 2026-06-03-1057-pipeline-scout-arc-8-sg1-dev-runtime-spa
manual_order: 0
...
state: backlog
title: 'pipeline-scout: Arc 8/SG1 — dev_runtime space schema + port allocator'
type: task
...
# Phase 1 — research: Arc 8/SG1 — dev_runtime space schema + port allocator

Goal slug: `arc8-dev-schema` · Pipeline dir: `.cronos/pipeline/arc8-dev-schema/` · Sub-agent: `pipeline-scout`.
...
request_text = (verbatim from .cronos/pipeline/arc8-dev-schema/request.md)
```
