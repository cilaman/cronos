...
depends_on:
- 2026-06-03-1057-pipeline-analyst-arc-8-sg2-dev-runtime-p
id: 2026-06-03-1057-pipeline-architect-arc-8-sg2-dev-runtime
manual_order: 0
...
state: backlog
title: 'pipeline-architect: Arc 8/SG2 — dev runtime process manager + health poller'
type: task
...
# Phase 3 — design: Arc 8/SG2 — dev runtime process manager + health poller

Goal slug: `arc8-dev-process` · Pipeline dir: `.cronos/pipeline/arc8-dev-process/` · Sub-agent: `pipeline-architect`.
...
analysis_report_path = .cronos/pipeline/arc8-dev-process/analysis-report-arc8-dev-process.md
