...
depends_on:
- 2026-06-03-1057-pipeline-reviewer-arc-8-sg2-dev-runtime
id: 2026-06-03-1057-pipeline-doc-sync-arc-8-sg2-dev-runtime
manual_order: 0
...
state: backlog
title: 'pipeline-doc-sync: Arc 8/SG2 — dev runtime process manager + health poller'
type: task
...
# Phase 7 — doc: Arc 8/SG2 — dev runtime process manager + health poller

Goal slug: `arc8-dev-process` · Pipeline dir: `.cronos/pipeline/arc8-dev-process/` · Sub-agent: `pipeline-doc-sync`.
...
review_report_path = .cronos/pipeline/arc8-dev-process/review-report-arc8-dev-process--attempt<final_k>.md
