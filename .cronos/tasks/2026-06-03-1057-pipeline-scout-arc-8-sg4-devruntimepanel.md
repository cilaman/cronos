...
depends_on:
- 2026-06-03-1057-pipeline-doc-sync-arc-8-sg3-dev-runtime
id: 2026-06-03-1057-pipeline-scout-arc-8-sg4-devruntimepanel
manual_order: 0
...
state: backlog
title: 'pipeline-scout: Arc 8/SG4 — DevRuntimePanel + sidebar running indicator'
type: task
...
# Phase 1 — research: Arc 8/SG4 — DevRuntimePanel + sidebar running indicator

Goal slug: `arc8-dev-ui` · Pipeline dir: `.cronos/pipeline/arc8-dev-ui/` · Sub-agent: `pipeline-scout`.
...
request_text = (verbatim from .cronos/pipeline/arc8-dev-ui/request.md)
```
