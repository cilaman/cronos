...
id: 2026-06-03-1057-tester-arc-8-sg2-dev-runtime-process-man
manual_order: 0
...
state: backlog
title: 'tester: Arc 8/SG2 — dev runtime process manager + health poller'
type: task
...
# Phase 5 — test: Arc 8/SG2 — dev runtime process manager + health poller

Goal slug: `arc8-dev-process` · Pipeline dir: `.cronos/pipeline/arc8-dev-process/` · Sub-agent: `tester`.
...
space_id  = cronos-development
scope     = full-space
slug      = arc8-dev-process     # makes the tester emit test-report-{slug}.md too
```
...
`test-report-arc8-dev-process.md` artifact under `.cronos/pipeline/arc8-dev-process/`.
