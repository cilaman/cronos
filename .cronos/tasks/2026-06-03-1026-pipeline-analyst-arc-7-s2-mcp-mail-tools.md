...
depends_on:
- 2026-06-03-1026-pipeline-scout-arc-7-s2-mcp-mail-tools-m
id: 2026-06-03-1026-pipeline-analyst-arc-7-s2-mcp-mail-tools
manual_order: 0
...
state: backlog
title: 'pipeline-analyst: Arc 7/S2 — MCP mail tools + mount into agent runs'
type: task
...
# Phase 2 — analysis: Arc 7/S2 — MCP mail tools + mount into agent runs

Goal slug: `arc7-agent-mail-tools` · Pipeline dir: `.cronos/pipeline/arc7-agent-mail-tools/` · Sub-agent: `pipeline-analyst`.
...
request = (verbatim text of .cronos/pipeline/arc7-agent-mail-tools/request.md — do not paraphrase)
