...
id: 2026-06-03-1057-tester-arc-8-sg3-dev-runtime-api-sse-log
manual_order: 0
...
state: backlog
title: 'tester: Arc 8/SG3 — dev runtime API + SSE log stream'
type: task
...
# Phase 5 — test: Arc 8/SG3 — dev runtime API + SSE log stream

Goal slug: `arc8-dev-api` · Pipeline dir: `.cronos/pipeline/arc8-dev-api/` · Sub-agent: `tester`.
...
space_id  = cronos-development
scope     = full-space
slug      = arc8-dev-api     # makes the tester emit test-report-{slug}.md too
```
...
`test-report-arc8-dev-api.md` artifact under `.cronos/pipeline/arc8-dev-api/`.
