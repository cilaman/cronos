...
depends_on:
- 2026-06-03-1026-pipeline-analyst-arc-7-s2-mcp-mail-tools
id: 2026-06-03-1026-pipeline-architect-arc-7-s2-mcp-mail-too
manual_order: 0
...
state: backlog
title: 'pipeline-architect: Arc 7/S2 — MCP mail tools + mount into agent runs'
type: task
...
# Phase 3 — design: Arc 7/S2 — MCP mail tools + mount into agent runs

Goal slug: `arc7-agent-mail-tools` · Pipeline dir: `.cronos/pipeline/arc7-agent-mail-tools/` · Sub-agent: `pipeline-architect`.
...
analysis_report_path = .cronos/pipeline/arc7-agent-mail-tools/analysis-report-arc7-agent-mail-tools.md
scout_report_path    = .cronos/pipeline/arc7-agent-mail-tools/scout-report-arc7-agent-mail-tools.md
```
