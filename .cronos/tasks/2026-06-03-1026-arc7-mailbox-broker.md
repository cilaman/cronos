...
depends_on: []
id: 2026-06-03-1026-arc7-mailbox-broker
manual_order: 0
...
# Pipeline goal: Arc 7/S1 — Mailbox broker + persistence + API

Pipeline run scaffolded for Arc 7 inter-agent messaging.
Pipeline dir: `.cronos/pipeline/arc7-mailbox-broker/`
