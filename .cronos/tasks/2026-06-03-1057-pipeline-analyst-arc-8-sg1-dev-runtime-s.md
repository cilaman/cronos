...
depends_on:
- 2026-06-03-1057-pipeline-scout-arc-8-sg1-dev-runtime-spa
id: 2026-06-03-1057-pipeline-analyst-arc-8-sg1-dev-runtime-s
manual_order: 0
...
state: backlog
title: 'pipeline-analyst: Arc 8/SG1 — dev_runtime space schema + port allocator'
type: task
...
# Phase 2 — analysis: Arc 8/SG1 — dev_runtime space schema + port allocator

Goal slug: `arc8-dev-schema` · Pipeline dir: `.cronos/pipeline/arc8-dev-schema/` · Sub-agent: `pipeline-analyst`.
...
request = (verbatim text of .cronos/pipeline/arc8-dev-schema/request.md — do not paraphrase)
