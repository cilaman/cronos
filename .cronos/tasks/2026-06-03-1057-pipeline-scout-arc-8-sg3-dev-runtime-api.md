...
depends_on:
- 2026-06-03-1057-pipeline-doc-sync-arc-8-sg2-dev-runtime
id: 2026-06-03-1057-pipeline-scout-arc-8-sg3-dev-runtime-api
manual_order: 0
...
state: backlog
title: 'pipeline-scout: Arc 8/SG3 — dev runtime API + SSE log stream'
type: task
...
# Phase 1 — research: Arc 8/SG3 — dev runtime API + SSE log stream

Goal slug: `arc8-dev-api` · Pipeline dir: `.cronos/pipeline/arc8-dev-api/` · Sub-agent: `pipeline-scout`.
...
request_text = (verbatim from .cronos/pipeline/arc8-dev-api/request.md)
```
