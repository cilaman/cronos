...
id: 2026-06-03-1026-arc7-agent-mail-tools
manual_order: 0
...
# Pipeline goal: Arc 7/S2 — MCP mail tools + mount into agent runs

Pipeline run scaffolded for Arc 7 inter-agent messaging.
Pipeline dir: `.cronos/pipeline/arc7-agent-mail-tools/`
