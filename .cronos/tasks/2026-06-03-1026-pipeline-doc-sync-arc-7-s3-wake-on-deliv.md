...
depends_on:
- 2026-06-03-1026-pipeline-reviewer-arc-7-s3-wake-on-deliv
id: 2026-06-03-1026-pipeline-doc-sync-arc-7-s3-wake-on-deliv
manual_order: 0
...
state: backlog
title: 'pipeline-doc-sync: Arc 7/S3 — Wake-on-delivery + replayable message trace'
type: task
...
# Phase 7 — doc: Arc 7/S3 — Wake-on-delivery + replayable message trace

Goal slug: `arc7-wake-and-trace` · Pipeline dir: `.cronos/pipeline/arc7-wake-and-trace/` · Sub-agent: `pipeline-doc-sync`.
...
space  = $SPACE_DIR
review_report_path = .cronos/pipeline/arc7-wake-and-trace/review-report-arc7-wake-and-trace--attempt<final_k>.md
