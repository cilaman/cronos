...
depends_on: []
id: 2026-06-03-1026-pipeline-scout-arc-7-s3-wake-on-delivery
manual_order: 0
...
state: backlog
title: 'pipeline-scout: Arc 7/S3 — Wake-on-delivery + replayable message trace'
type: task
...
# Phase 1 — research: Arc 7/S3 — Wake-on-delivery + replayable message trace

Goal slug: `arc7-wake-and-trace` · Pipeline dir: `.cronos/pipeline/arc7-wake-and-trace/` · Sub-agent: `pipeline-scout`.
...
request_text = (verbatim from .cronos/pipeline/arc7-wake-and-trace/request.md)
```
