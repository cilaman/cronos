...
depends_on: []
id: 2026-06-03-1026-pipeline-scout-arc-7-s1-mailbox-broker-p
manual_order: 0
...
state: backlog
title: 'pipeline-scout: Arc 7/S1 — Mailbox broker + persistence + API'
type: task
...
# Phase 1 — research: Arc 7/S1 — Mailbox broker + persistence + API

Goal slug: `arc7-mailbox-broker` · Pipeline dir: `.cronos/pipeline/arc7-mailbox-broker/` · Sub-agent: `pipeline-scout`.
...
request_text = (verbatim from .cronos/pipeline/arc7-mailbox-broker/request.md)
```
