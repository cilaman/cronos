...
depends_on:
- 2026-06-03-1026-pipeline-reviewer-arc-7-s4-inbox-panel-t
id: 2026-06-03-1026-pipeline-doc-sync-arc-7-s4-inbox-panel-t
manual_order: 0
...
state: backlog
title: 'pipeline-doc-sync: Arc 7/S4 — Inbox panel + two-task e2e'
type: task
...
# Phase 7 — doc: Arc 7/S4 — Inbox panel + two-task e2e

Goal slug: `arc7-inbox-ui-e2e` · Pipeline dir: `.cronos/pipeline/arc7-inbox-ui-e2e/` · Sub-agent: `pipeline-doc-sync`.
...
space  = $SPACE_DIR
review_report_path = .cronos/pipeline/arc7-inbox-ui-e2e/review-report-arc7-inbox-ui-e2e--attempt<final_k>.md
