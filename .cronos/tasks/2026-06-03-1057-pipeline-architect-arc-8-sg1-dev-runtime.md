...
depends_on:
- 2026-06-03-1057-pipeline-analyst-arc-8-sg1-dev-runtime-s
id: 2026-06-03-1057-pipeline-architect-arc-8-sg1-dev-runtime
manual_order: 0
...
state: backlog
title: 'pipeline-architect: Arc 8/SG1 — dev_runtime space schema + port allocator'
type: task
...
# Phase 3 — design: Arc 8/SG1 — dev_runtime space schema + port allocator

Goal slug: `arc8-dev-schema` · Pipeline dir: `.cronos/pipeline/arc8-dev-schema/` · Sub-agent: `pipeline-architect`.
...
The sub-agent writes its CC-v1 artifact under `.cronos/pipeline/arc8-dev-schema/` and returns a
short conversational summary; do not paraphrase or post-process its output here.

```text
slug   = arc8-dev-schema
space  = $SPACE_DIR    (resolved from $PWD as in Step 2)
analysis_report_path = .cronos/pipeline/arc8-dev-schema/analysis-report-arc8-dev-schema.md
scout_report_path    = .cronos/pipeline/arc8-dev-schema/scout-report-arc8-dev-schema.md
```
