...
depends_on:
- 2026-06-03-1057-pipeline-reviewer-arc-8-sg1-dev-runtime
id: 2026-06-03-1057-pipeline-doc-sync-arc-8-sg1-dev-runtime
manual_order: 0
...
state: backlog
title: 'pipeline-doc-sync: Arc 8/SG1 — dev_runtime space schema + port allocator'
type: task
...
# Phase 7 — doc: Arc 8/SG1 — dev_runtime space schema + port allocator

Goal slug: `arc8-dev-schema` · Pipeline dir: `.cronos/pipeline/arc8-dev-schema/` · Sub-agent: `pipeline-doc-sync`.
...
review_report_path = .cronos/pipeline/arc8-dev-schema/review-report-arc8-dev-schema--attempt<final_k>.md
