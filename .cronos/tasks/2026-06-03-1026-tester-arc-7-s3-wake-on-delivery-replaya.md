...
id: 2026-06-03-1026-tester-arc-7-s3-wake-on-delivery-replaya
manual_order: 0
...
state: backlog
title: 'tester: Arc 7/S3 — Wake-on-delivery + replayable message trace'
type: task
...
# Phase 5 — test: Arc 7/S3 — Wake-on-delivery + replayable message trace

Goal slug: `arc7-wake-and-trace` · Pipeline dir: `.cronos/pipeline/arc7-wake-and-trace/` · Sub-agent: `tester`.
...
emits CC-v1 `test-report-arc7-wake-and-trace.md` under `.cronos/pipeline/arc7-wake-and-trace/`.
