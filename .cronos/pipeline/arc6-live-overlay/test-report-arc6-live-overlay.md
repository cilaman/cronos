...
Gate run for goal `arc6-live-overlay` in space `cronos-development`. 3036 tests passed, 0 failed, 0 errored, 0 skipped. Coverage: 84.3%. Gate decision: **PASS**.
...
Gate result: **PASS** — 3036p / 0f / 0e, coverage 84.3%.
