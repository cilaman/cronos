...
Gate run for goal `gui-button-focus` in space `cronos-development`. 2767 tests passed, 664 failed, 836 errored, 0 skipped. Coverage: 50.5%. Gate decision: **FAIL**.
...
Gate result: **FAIL** — 2767p / 664f / 836e, coverage 50.5%.
Fix 1500 failing/errored test(s) before advancing the pipeline. See ## Failures for details.
