...
inputs_used:
  ...
  - README.md
outputs_produced:
  - .cronos/pipeline/smoke-csv-export-broken/scout-report-smoke-csv-export-broken.md
blockers: []
...
2. The slug smoke-csv-export-broken is reserved exclusively for regression fixtures.
